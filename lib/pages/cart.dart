    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: <Widget>[
          ...
          Column(
            children: <Widget>[
              // Replace the entire GestureFlipCard section with this beautiful redesigned button area
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: Color(0xff3C6255).withOpacity(0.3),
                            blurRadius: 12,
                            spreadRadius: 2,
                            offset: Offset(0, 4),
                          ),
                      ...
                      child: Column(
                        children: [
                          ...
                          // Expandable Section for Discount and Tax
                          Container(
                            decoration: BoxDecoration(
                                            ...
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  prefixStyle: TextStyle(color: Colors.white.withOpacity(0.9)),
                                                ),
